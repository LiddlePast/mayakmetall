        ...
        <div class="footer__left space-y-5">
            ...
            <div class="footer__contacts contacts max-w-[450px]">
                ...
                <div class="contacts__phone">
                    <p>Телефон: <a href="tel:+73916129782" class="hover:text-accent transition-colors">+73916129782</a>,
                        <a href="tel:+73912883315" class="hover:text-accent transition-colors">+73912883315</a></p>
                </div>
                <div class="contacts__mail">
                    <p>Эл. почта: <a href="mailto:kzlmk2004@mail.ru" class="hover:text-accent transition-colors">kzlmk2004@mail.ru</a>,
                        <a href="mailto:3125@mayakmetall.ru" class="hover:text-accent transition-colors">3125@mayakmetall.ru</a>
                    </p>
                </div>
