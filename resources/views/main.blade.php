...
@section('main')
    ...
    <section
        ...
        <div
            class="section-bg bg-[url('/public/images/hero.png')] w-full h-full absolute inset-0 brightness-[0.4] bg-cover bg-no-repeat"></div>
    ...
    <section class="main__section-benefits section-benefits section py-10">
        <div class="section-benefits__benefit flex items-center">
            ...
            <div class="benefit__image grow max-w-[50%] h-[500px]">
                <img src="{{ asset('/images/self.webp') }}" alt="Собственное производство" class="object-cover object-center w-full h-full">
            </div>
        </div>
        <div class="section-benefits__benefit flex items-center">
            <div class="benefit__image grow max-w-[50%] h-[500px]">
                <img src="{{ asset('/images/team.webp') }}" alt="Команда профессионалов" class="object-cover object-center w-full h-full">
            </div>
            <div class="benefit__text grow max-w-[50%] p-10">
        ...
        <div class="section-benefits__benefit flex items-center">
            ...
            <div class="benefit__image grow max-w-[50%] h-[500px]">
                <img src="{{ asset('/images/done.webp') }}" alt="Готовые проектные решения" class="object-cover object-center w-full h-full">
            </div>
        </div>
    </section>
@endsection
