...
@section('main')
    <section class="main__section-dashboard section-dashboard section py-10 px-5">
        <div class="section-dashboard__heading max-w-[1400px] mx-auto">
            <h2 class="text-3xl font-bold">Панель управления</h2>
        </div>
    </section>
    <section class="main__section-dashboard-actions dashboard-actions section px-5">
